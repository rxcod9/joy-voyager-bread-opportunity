...
namespace Joy\VoyagerBreadOpportunity\Models;
...
use Joy\VoyagerBreadOpportunity\Database\Factories\OpportunityFactory;
...
class Opportunity extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('Opportunity'));
    }
